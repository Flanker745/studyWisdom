...
function StudentNotes() {
  ...
  useEffect(() => {
    const fetchNotes = async (coaching_id, classes) => {
      try {
    ...
    if (Object.keys(exitUserDetails).length > 0) {
      ...
      fetchNotes(coaching_id, classes);
    }
  }, [exitUserDetails]);
  ...
  return (
    <div>
      <div className="w-[95%] space-y-5 mt-9 sm:w-3/4 m-auto">
        <h4 className="text-center md:text-4xl">Notes</h4>
